      ...
      <div class="container h-100 d-flex justify-content-center">
          <div class="row h-100 justify-content-center align-content-center d-flex">
            <form class="col-12 mt-5" action="<%=request.getContextPath() + UrlConst.GAME_PLAY %>" method="post">
              ...
              <div class="form-group text-center">
                <label for="tryNumber">${message_2}</label>
              ...
              <button ${!record.isFinished ? "hidden": ""} type="submit" name="Retry" class="btn btn-warning" value="Retry" >Retry</button>
            </form>
            <form class="col-12 mt-2" action="<%=request.getContextPath() + UrlConst.GAME_RANKING %>" method="get">
            <button type="submit" class="btn btn-danger">Ranking</button>
            </form>
            <form class="col-12 mt-2" action="<%=request.getContextPath() + UrlConst.GAME_LOGIN %>" method="get">
